...
#    Updated: 2019/08/17 02:24:40 by pmogwere         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
NAME=libft.a
...
ft_strtrim.c ft_strsplit.c ft_itoa.c ft_pow.c \
...
ft_putnbrlong.c ft_putnbrlong_fd.c ft_printhex.c ft_strspn.c ft_itoa_base.c \
ft_intlen_base.c \
